...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        XXXXXXX,KC_A, LT(SYMB, KC_S),LCTL_T(KC_D),LSFT_T(KC_F),KC_G,KC_BSPC,   XXXXXXX,LT(MDIA,KC_H), LSFT_T(KC_J),LCTL_T(KC_K),LT(SYMB,KC_L),KC_SCLN,XXXXXXX,
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        _______, XXXXXXX, KC_PIPE,KC_QUOT, KC_SLSH, XXXXXXX, _______,           _______, KC_UP,   KC_7,    KC_8,    KC_9,    XXXXXXX, KC_F12,
    ...
    [SQUASH] = LAYOUT_moonlander(
        ...
        XXXXXXX, XXXXXXX,XXXXXXX, LCTL_T(KC_A),LSFT_T(KC_G),XXXXXXX, XXXXXXX,     XXXXXXX,XXXXXXX,LSFT_T(KC_H),LCTL_T(KC_SCLN), XXXXXXX, XXXXXXX, XXXXXXX,
